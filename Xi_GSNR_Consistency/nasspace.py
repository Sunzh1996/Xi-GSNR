...
class Nasbench201:
    def __init__(self, dataset, apiloc, num_classes):
    ...
    def get_final_accuracy(self, uid, acc_type, trainval):
        ...
        if self.dataset == 'cifar10' and trainval:
            ...
            info = self.api.query_meta_info_by_index(uid, hp='200').get_metrics('cifar10', 'ori-test')
...
def get_search_space(args):
    if args.nasspace == 'nasbench201':
        return Nasbench201(args.dataset, args.api_loc, args.num_classes)
